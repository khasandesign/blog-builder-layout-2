...
$header = component('layout/header', [
    'size' => 'md',
    'name' => 'Our Blog',
    'title' => 'Our Blog – Review Articles',
    'description' => 'All about the history of handmade and handmade businesses in our blog.'
]);
...
$sidebar = component('layout/sidebar', [
    'parts' => [
        ...
        [
            'target' => '',
            'sections' => ['search_tag', 'trending', 'info']
        ],
        [
            'target' => 'videos',
            'sections' => ['hot_deals']
...
<div class="container">
    ...
    <div class="row content">
        ...
        <div class="col-xl-6 col-lg-8">
            <div class="feed">
                <section id="articles">
                    <h4 class="section-heading mt-0">Articles</h4>
                ...
                <section id="videos">
                    ...
                    <?php foreach ($this->videos as $section_videos) {
                        ?>
                        <hr>
